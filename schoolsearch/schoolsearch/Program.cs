...
namespace Schoolsearch
{
    internal class Program
    {
        ...
        static void ShowMainMenu()
        {
            ...
            Console.WriteLine("         ║           G - Search classroom (students)                ║");
            Console.WriteLine("         ║           C - Search classroom (teachers)                ║");
            ...
            while (true)
            {
                ...
                if (result.KeyChar == 'T' || result.KeyChar == 't' || result.KeyChar == 'S' ||
                    ...
                    result.KeyChar == 'g' || result.KeyChar == 'G' || 
        ...
        static void ShowSearchClassroom()
        {
            ...
            Console.Clear();
            Console.WriteLine("         ╔══════════════════════════════════════════════════════════╗");
            Console.WriteLine("         ║                 SEARCH STUDENT BY CLASSROOM              ║");
            Console.WriteLine("         ╚══════════════════════════════════════════════════════════╝");
            Console.WriteLine();
            Console.WriteLine();
            while (true)
            ...
            var timer = new System.Diagnostics.Stopwatch();
            timer.Start();
            myschool.GetFilteredData(ref data, FilterType.FT_ClassroomStudent, ref RecordCount, "", classroom);
            timer.Stop();
        ...
        static void ShowSearchClassroomTeacher()
        {
            string tmpValue;
            int classroom;
            string data = "";
            ...
            Console.Clear();
            Console.WriteLine("         ╔══════════════════════════════════════════════════════════╗");
            Console.WriteLine("         ║                 SEARCH TEACHER BY CLASSROOM              ║");
            Console.WriteLine("         ╚══════════════════════════════════════════════════════════╝");
            Console.WriteLine();
            Console.WriteLine();
            while (true)
            ...
            var timer = new System.Diagnostics.Stopwatch();
            timer.Start();
            myschool.GetFilteredData(ref data, FilterType.FT_ClassroomTeacher, ref RecordCount, "", classroom);
            timer.Stop();
